...
fn test_parse_my_class() {
    let bytes = test_data_class!("rustybytecode", "org/rustybytecode/test/MyClass");
    ...
    assert_eq!("org/rustybytecode/test/MyClass", my_class.binary_name);
    assert_eq!(
...
fn parse_anno() {
    for bytes in [
        test_data_class!("rustybytecode", "org/rustybytecode/test/Anno"),
        test_data_class!("rustybytecode", "org/rustybytecode/test/Anno$Middle"),
    ] {
...
fn parse_complicated_class() {
    for bytes in [
        test_data_class!("rustybytecode", "org/rustybytecode/test/ComplicatedClass"),
        test_data_class!("rustybytecode", "org/rustybytecode/test/ComplicatedClass$InnerClass"),
        test_data_class!("rustybytecode", "org/rustybytecode/test/ComplicatedClass$1Test"),
    ] {
        Class::from_reader(bytes).unwrap();
    }
}
...
fn parse_module_info() {
    let bytes = test_data_class!("rustybytecode", "module-info");
...
#[test]
fn parse_record() {
    let bytes = test_data_class!("rustybytecode", "org/rustybytecode/test/RecordTest");
    let class = Class::from_reader(bytes).unwrap();
    assert_eq!("org/rustybytecode/test/RecordTest", class.binary_name);
