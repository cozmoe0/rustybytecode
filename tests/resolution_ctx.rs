...
fn load_classes() {
    ...
    assert!(ctx
        .application_classes
        .contains_key(&ClassRef::new("org/rustybytecode/test/TestAnalysis")));
}
...
fn interfaces_impl() {
    ...
    let implements = ctx
        ...
        .implemented_interfaces(&ClassRef::new("org/rustybytecode/test/MyClass"));
    assert!(implements
        .iter()
