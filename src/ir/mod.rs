//! `RustybytecodeIR` is an intermediate representation of JVM bytecode.
...
pub use generator::{RustybytecodeIRBrewingError, RustybytecodeIRMethodExt};
pub use jvm_instruction::*;
...
/// Represents a JVM method where the instructions have been converted to Rustybytecode IR.
#[derive(Debug, Clone)]
pub struct RustybytecodeIRMethod {
    ...
    pub instructions: InstructionList<RustybytecodeInstruction>,
...
pub struct DefUseChain<'a> {
    method: &'a RustybytecodeIRMethod,
