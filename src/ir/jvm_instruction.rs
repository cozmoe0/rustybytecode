...
/// Represents a single instruction in the Rustybytecode IR.
#[derive(Debug, Clone, PartialEq, Eq, derive_more::Display)]
pub enum RustybytecodeInstruction {
    /// A no-op instruction.
    #[display("nop")]
    Nop,
    ...
    /// Jumps to [`target`](RustybytecodeInstruction::Jump::target) if [`condition`](RustybytecodeInstruction::Jump::condition) holds.
    /// Unconditionally jumps to [`target`](RustybytecodeInstruction::Jump::target) if [`condition`](RustybytecodeInstruction::Jump::condition) is [`None`].
    ...
    /// Jump to the [`target`](RustybytecodeInstruction::Switch::default) corresponding to [`match_value`](RustybytecodeInstruction::Switch::match_value).
    /// If [`match_value`](RustybytecodeInstruction::Switch::match_value) does not match any [`target`](RustybytecodeInstruction::Switch::branches), jump to [`default`](RustybytecodeInstruction::Switch::default).
    #[display(
        "switch {} {{ {}, else => {} }}",
        match_value,
...
/// Represents a reference to a value in the Rustybytecode IR.
